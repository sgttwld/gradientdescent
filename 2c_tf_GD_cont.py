"""
Example of a sampling based gradient descent (ascent) implementation in tensorflow to find the parameters of a probability distribution that maximizes the expected value of a given utility function
