"""
Example of a gradient descent (ascent) implementation in tensorflow to find the discrete probability distribution that maximizes the expected value of a given function
