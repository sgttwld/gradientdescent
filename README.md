...
1. **Minimize a function**: [Find the argument](https://github.com/sgttwld/gradientdescent/blob/master/1_tf_GD.py) of a function where the minimal value is achieved. 
